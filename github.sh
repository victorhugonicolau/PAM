...
export name='vitorhugonicolau'
export email="victor.castro29@etec.sp.gov"
export repositorio="https://github.com/victorhugonicolau/PAM.git";

#Daqui pra baixo mexa somente se for realmente necessário ou se souber o que está fazendo :P

export branch_name="aula-$(date +%d%m%Y-%H%M%S)"
